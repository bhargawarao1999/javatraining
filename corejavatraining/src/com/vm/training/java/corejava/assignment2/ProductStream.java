...
public class ProductStream {
	...
	public static void main(String[] args) {
		...
		productList.add(new Product(1, "Mouse", "Electronics", 500, 10));
		productList.add(new Product(2, "KeyBoard", "Electronics",1500 ,10 ));
		productList.add(new Product(3, "Laptop", "Electronics",50000 ,5 ));
		productList.add(new Product(4, "Paneer", "Veg",20 ,10 ));
